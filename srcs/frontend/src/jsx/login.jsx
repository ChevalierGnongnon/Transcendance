	...
	return (
		<div className="d-flex justify-content-center align-items-center min-vh-100">
			<form className="login-form d-flex flex-column gap-3" onSubmit={manageSubmit} >
				...
				<input type="password" name="last_name" value={password} placeholder="Password" className="form-control form-input" id="password" onChange={(e) => setLastName(e.target.value)} />
