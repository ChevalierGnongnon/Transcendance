	...
	return (
		<div className="d-flex justify-content-center align-items-center min-vh-100">
			<form className="login-form d-flex flex-column gap-3" onSubmit={manageSubmit} >
				...
				<input type="text" name="name" value={login} placeholder="login or email" className="form-control form-input" id="login" onChange={(e) => setLogin(e.target.value)} />
				<label htmlFor="password" className="form-text">t('common.label_password')</label>
				<input type="password" name="last_name" value={password} placeholder="Password" className="form-control form-input" id="password" onChange={(e) => setPassword(e.target.value)} />
