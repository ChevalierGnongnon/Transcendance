	...
	return (
		<div className="d-flex justify-content-center align-items-center min-vh-100">
			<form className="register-form d-flex flex-column gap-3" onSubmit={manageSubmit} >
				...
				<input type="text" name="name" value={name} placeholder={t('register.placeholder_name')} className="form-control register-input" id="name" onChange={(e) => setName(e.target.value)}/>
				<label htmlFor="last_name" className="form-text">{t('register.label_lastname')}</label>
				<input type="text" name="last_name" value={last_name} placeholder={t('register.placeholder_lastname')} className="form-control register-input" id="last_name" onChange={(e) => setLastName(e.target.value)}/>
				<label htmlFor="pseudo" className="form-text">{t('register.label_pseudo')}</label>
				<input type="text" name="pseudo" value={pseudo} placeholder={t('register.placeholder_pseudo')} className="form-control register-input" id="pseudo" onChange={(e) => setPseudo(e.target.value)}/>
				...
				<input type="password" name="password" value={password} placeholder={t('common.placeholder_password')} className="form-control register-input" id="password" onChange={(e) => setPassword(e.target.value)}/>
				<label htmlFor="password_verify" className="form-text">{t('common.label_password_verify')}</label>
				<input type="password" name="password_verify" value={passwordVerify} placeholder={t('common.placeholder_password_verify')} className="form-control register-input" id="password_verify" onChange={(e) => setPasswordVerify(e.target.value)}/>
